...
> 这是一次**真实 SDK 升级**的完整 diff 记录。配合 [`bug_report/4_sdk_drift.md`](../../4_sdk_drift.md) 理论 + [09_sdk_upgrade.md](../../../main/ZH/methodology/09_sdk_upgrade.md) playbook 食用。
...
下次升级**严格按照** [09_sdk_upgrade.md](../../../main/ZH/methodology/09_sdk_upgrade.md) 的 7 步走，主要 lift-and-shift 这个目录的工具链：
...
- Playbook：[09_sdk_upgrade.md](../../../main/ZH/methodology/09_sdk_upgrade.md)
