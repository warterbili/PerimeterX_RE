...
一套**预配置 iFood**的脚本 —— 路径写死、TAG 写死、一行命令出结果。
...
├── source/          ← iFood SDK 锁定（如有）
└── script/          ← 本目录（7 个工具 + README）
```
...
# Step 2: 跑字段三分类
python diff_samples.py 1          # EV1（14 字段）
python diff_samples.py 2          # EV2（~204 字段）
...
# 流程图：
#
# collector 返 200 但 do:null 永远没 _px3
#         ↓
...
| 通用版脚本（不写死 iFood 的） | [`../../../skill/AI_re/scripts/`](../../../skill/AI_re/scripts/) |
| 怎么重抓 6 批 | [`../../../skill/cdp/scripts/capture_via_cdp_ifood.py`](../../../skill/cdp/scripts/capture_via_cdp_ifood.py) |
| 19 条踩坑 | [`../../../skill/AI_re/references/gotchas.md`](../../../skill/AI_re/references/gotchas.md) |

---

*这些脚本是从 iFood 2026-05 实战逆向中提炼的，全部 iFood 路径/常量已写死。
