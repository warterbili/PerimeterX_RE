#!/usr/bin/env python3
"""
diff_samples.py — iFood 6 批 EV 字段三分类
...
用法:
  python diff_samples.py 1      # 看 EV1 (POST #1 的 payload)
  python diff_samples.py 2      # 看 EV2 (POST #2 的 payload)
...
# 打印 summary
print(f"═══ iFood EV{WHICH} 字段三分类（{len(batches)} 批）═══")
