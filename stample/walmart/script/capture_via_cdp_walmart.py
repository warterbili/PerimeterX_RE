...
URL = os.environ.get("PX_URL") or "https://www.walmart.com/"
APP_ID_HINT = "PXu6b0qd2S"
...
SDK_URL_MATCHERS = [
    ...
    "client.px-cloud.net/PXu6b0qd2S/main.min.js",
]
COLLECTOR_PATH_MATCHERS = [
    "collector-pxu6b0qd2s.px-cloud.net/api/v2/collector",
    "/api/v2/collector",
]
BUNDLE_PATH_MATCHERS = [
    "/px/PXu6b0qd2S/assets/js/bundle",
]
    ...
    async with CDPClient(browser_ws) as browser:
        ...
        if sdk_path.exists():
            ...
            (SDK_DIR / "INFO.json").write_text(json.dumps({
                ...
                "url": "https://client.px-cloud.net/PXu6b0qd2S/main.min.js",
                "captured_at": time.strftime("%Y-%m-%dT%H:%M:%SZ", time.gmtime()),
